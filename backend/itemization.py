...
FULL_ITEM_CATALOG: List[Dict] = [
    ...
    _item("warrior", "ability", "common",   "Bash Sigil",
          ...
          image_path="/items/warrior_ability.png"),
    ...
    _item("warrior", "ability", "rare",     "Titan Bash Sigil",
          "An elite bash sigil for arena control.",
          ability_bonus=14, ability_key="warrior_bash", ability_cooldown_ms=8000,
          image_path="/items/warrior_ability.png"),
    _item("mage",    "ability", "common",   "Fireball Rune",
          ...
          image_path="/items/mage_ability.png"),
    _item("mage",    "ability", "uncommon", "Ember Rune",
          "A refined rune that strengthens fireball casting.",
          ability_bonus=10, ability_key="mage_fireball", ability_cooldown_ms=6000,
          image_path="/items/mage_ability.png"),
    _item("mage",    "ability", "rare",     "Inferno Rune",
          "A volatile rune for high-pressure ranged bursts.",
          ability_bonus=16, ability_key="mage_fireball", ability_cooldown_ms=6000,
          image_path="/items/mage_ability.png"),
    _item("rogue",   "ability", "common",   "Blink Charm",
          ...
          image_path="/items/rogue_ability.png"),
    _item("rogue",   "ability", "uncommon", "Shadowstep Charm",
          "A sharper blink charm for stronger ambushes.",
          ability_bonus=6, ability_key="rogue_blink", ability_cooldown_ms=5000,
          image_path="/items/rogue_ability.png"),
    _item("rogue",   "ability", "rare",     "Nightfall Charm",
          "An elite blink charm made for decisive repositioning.",
          ability_bonus=10, ability_key="rogue_blink", ability_cooldown_ms=5000,
          image_path="/items/rogue_ability.png"),
    # --- Warrior armor ---
