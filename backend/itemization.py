...
FULL_ITEM_CATALOG: List[Dict] = [
    ...
    _item("warrior", "ability", "common",   "Cleave Sigil",
          "Unlocks a fast frontal cleave that damages and pushes enemies back.",
          ability_bonus=4, ability_key="warrior_bash", ability_cooldown_ms=6200,
          image_path="/items/skills/warrior_bash.png"),
    _item("warrior", "ability", "uncommon", "Guardbreaker Sigil",
          "Unlocks a guard-breaking strike that punishes blocking opponents.",
          ability_bonus=8, ability_key="warrior_guardbreak", ability_cooldown_ms=7000,
          image_path="/items/skills/warrior_guardbreak.png"),
    _item("warrior", "ability", "rare",     "Titan Slam Sigil",
          "Unlocks a heavy ground slam with knockback and a short stun.",
          ability_bonus=14, ability_key="warrior_titan_bash", ability_cooldown_ms=9200,
          image_path="/items/skills/warrior_titan_bash.png"),
    _item("mage",    "ability", "common",   "Flare Bolt Rune",
          "Unlocks a quick ranged bolt with light knockback.",
          ability_bonus=5, ability_key="mage_fireball", ability_cooldown_ms=4800,
          image_path="/items/skills/mage_fireball.png"),
    _item("mage",    "ability", "uncommon", "Ember Rune",
          "Unlocks a faster ember bolt with improved arena pressure.",
          ability_bonus=10, ability_key="mage_ember_bolt", ability_cooldown_ms=5500,
          image_path="/items/skills/mage_ember_bolt.png"),
    _item("mage",    "ability", "rare",     "Inferno Rune",
          "Unlocks a heavy inferno blast with stronger damage and knockback.",
          ability_bonus=16, ability_key="mage_inferno_blast", ability_cooldown_ms=7500,
          image_path="/items/skills/mage_inferno_blast.png"),
    _item("rogue",   "ability", "common",   "Quickstep Charm",
          "Unlocks a short dash strike that cuts while repositioning.",
          ability_bonus=3, ability_key="rogue_blink", ability_cooldown_ms=5200,
          image_path="/items/skills/rogue_blink.png"),
    _item("rogue",   "ability", "uncommon", "Shadowstep Charm",
          "Unlocks a longer shadowstep for stronger repositioning.",
          ability_bonus=6, ability_key="rogue_shadowstep", ability_cooldown_ms=4500,
          image_path="/items/skills/rogue_shadowstep.png"),
    _item("rogue",   "ability", "rare",     "Nightfall Charm",
    ...
    # ── Epic / Legendary SET pieces (boss drop only) ─────────────────────────────
    # Drop-only (price 0). Weapon/ability carry a passive ONLY at these tiers (set power).
    # Armor uses the Roman legion (epic) / plate (legendary) visuals; abilities reuse the
    # class's strongest existing skill key with higher bonus + a passive. The "set glow"
    # is a frontend rarity effect (epic purple / legendary gold).
    # --- Warrior ---
    _item("warrior", "weapon", "epic", "Centurion Katana",
          "A gilded katana carried by the arena's centurions.",
          attack_bonus=16, hp_bonus=8, passive_type="boss_damage_percent", passive_value=0.08),
    _item("warrior", "weapon", "legendary", "Imperator Katana",
          "The emperor's own blade — legend made steel.",
          attack_bonus=22, hp_bonus=12, passive_type="boss_damage_percent", passive_value=0.14),
    _item("warrior", "armor", "epic", "Praetorian Plate",
          "Ornate plate of the elite Praetorian guard.",
          hp_bonus=46, passive_type="damage_reduction_percent", passive_value=0.11,
          image_path="/items/warrior_armor_legion.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.legion"}),
    _item("warrior", "armor", "legendary", "Imperial Aegis",
          "Impenetrable imperial plate forged for champions.",
          hp_bonus=60, passive_type="damage_reduction_percent", passive_value=0.15,
          image_path="/items/warrior_armor_chainmail.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.plate"}),
    _item("warrior", "ability", "epic", "Colossus Slam Sigil",
          "An empowered titan slam that crushes guards.",
          ability_bonus=20, passive_type="bonus_attack_percent", passive_value=0.08,
          ability_key="warrior_titan_bash", ability_cooldown_ms=9200,
          image_path="/items/skills/warrior_titan_bash.png"),
    _item("warrior", "ability", "legendary", "Titanfall Sigil",
          "The ultimate slam — the ground itself recoils.",
          ability_bonus=28, passive_type="bonus_attack_percent", passive_value=0.12,
          ability_key="warrior_titan_bash", ability_cooldown_ms=9200,
          image_path="/items/skills/warrior_titan_bash.png"),
    # --- Mage ---
    _item("mage", "weapon", "epic", "Archmage Staff",
          "A staff humming with channeled arcane storms.",
          attack_bonus=8, ability_bonus=16, passive_type="bonus_ability_percent", passive_value=0.10),
    _item("mage", "weapon", "legendary", "Staff of the Magus",
          "A relic staff that bends raw magic to its wielder.",
          attack_bonus=11, ability_bonus=22, passive_type="bonus_ability_percent", passive_value=0.16),
    _item("mage", "armor", "epic", "Runed Vestments",
          "Vestments inscribed with glowing battle-runes.",
          hp_bonus=26, passive_type="bonus_ability_percent", passive_value=0.16,
          image_path="/items/mage_armor_mystic.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.legion"}),
    _item("mage", "armor", "legendary", "Astral Regalia",
          "Regalia woven from starlight and pure mana.",
          hp_bonus=34, passive_type="bonus_ability_percent", passive_value=0.22,
          image_path="/items/mage_armor_mystic.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.plate"}),
    _item("mage", "ability", "epic", "Cataclysm Rune",
          "An inferno blast swollen to cataclysmic force.",
          ability_bonus=22, passive_type="bonus_ability_percent", passive_value=0.10,
          ability_key="mage_inferno_blast", ability_cooldown_ms=7500,
          image_path="/items/skills/mage_inferno_blast.png"),
    _item("mage", "ability", "legendary", "Apocalypse Rune",
          "The final spell — the arena burns to ash.",
          ability_bonus=30, passive_type="bonus_ability_percent", passive_value=0.15,
          ability_key="mage_inferno_blast", ability_cooldown_ms=7500,
          image_path="/items/skills/mage_inferno_blast.png"),
    # --- Rogue ---
    _item("rogue", "weapon", "epic", "Assassin's Scimitar",
          "A whisper-quiet blade that drinks vitality.",
          attack_bonus=12, risk_win_chance=0.12, passive_type="lifesteal_percent", passive_value=0.06),
    _item("rogue", "weapon", "legendary", "Reaper's Edge",
          "A legendary edge that reaps life with every cut.",
          attack_bonus=16, risk_win_chance=0.16, passive_type="lifesteal_percent", passive_value=0.10),
    _item("rogue", "armor", "epic", "Phantom Leather",
          "Leather that fades the wearer between strikes.",
          hp_bonus=32, passive_type="lifesteal_percent", passive_value=0.06,
          image_path="/items/rogue_armor_shadow.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.legion"}),
    _item("rogue", "armor", "legendary", "Wraithweave",
          "Spectral weave that turns wounds into lifeblood.",
          hp_bonus=42, passive_type="lifesteal_percent", passive_value=0.09,
          image_path="/items/rogue_armor_shadow.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.plate"}),
    _item("rogue", "ability", "epic", "Eclipse Charm",
          "A nightfall ambush that strikes from total darkness.",
          ability_bonus=14, passive_type="risk_success_bonus", passive_value=0.08,
          ability_key="rogue_nightfall", ability_cooldown_ms=6800,
          image_path="/items/skills/rogue_nightfall.png"),
    _item("rogue", "ability", "legendary", "Voidstep Charm",
          "A step through the void — none can follow.",
          ability_bonus=20, passive_type="risk_success_bonus", passive_value=0.12,
          ability_key="rogue_nightfall", ability_cooldown_ms=6800,
          image_path="/items/skills/rogue_nightfall.png"),
    # ── Roman Armor set (Nila122, CC-BY-SA 3.0) ─────────────────────────────────
    # Armor: bronze (uncommon shop), steel (rare shop), gold (epic boss-only).
    # Helmets: bronze Galea (uncommon), steel Galea (rare), gold Galea (epic).
    # All per-class armor; helmets shared ('any'). LPC overlays from Roman armor pack.
    # --- Warrior ---
    _item("warrior", "armor", "uncommon", "Roman Lorica Bronze",
          "Bronze lorica segmentata of the early legions.",
          hp_bonus=24, passive_type="damage_reduction_percent", passive_value=0.05,
          image_path="/items/warrior_armor_legion.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.roman_legion_bronze"}),
    _item("warrior", "armor", "rare", "Roman Lorica Steel",
          "Hardened steel lorica favoured by centurions.",
          hp_bonus=36, passive_type="damage_reduction_percent", passive_value=0.08,
          image_path="/items/warrior_armor_chainmail.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.roman_legion_steel"}),
    ...
    # --- Mage ---
    _item("mage", "armor", "uncommon", "Mage Bronze Wrappings",
          "Bronze-threaded cloth used by battle-magi.",
          hp_bonus=14, passive_type="bonus_ability_percent", passive_value=0.08,
          image_path="/items/mage_armor_arcane.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.roman_legion_bronze"}),
    _item("mage", "armor", "rare", "Mage Steel Vestments",
          "Steel-reinforced vestments for front-line magi.",
          hp_bonus=22, passive_type="bonus_ability_percent", passive_value=0.12,
          image_path="/items/mage_armor_mystic.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.roman_legion_steel"}),
    _item("mage", "armor", "epic", "Arcane Gold Lorica",
          "Imperial gold lorica enchanted to channel raw arcane energy.",
          hp_bonus=30, passive_type="bonus_ability_percent", passive_value=0.17,
          image_path="/items/mage_armor_mystic.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.roman_legion_gold"}),
    # --- Rogue ---
    _item("rogue", "armor", "uncommon", "Rogue Bronze Cuirass",
          "Lightweight bronze cuirass for hit-and-run tactics.",
          hp_bonus=16, passive_type="risk_success_bonus", passive_value=0.05,
          image_path="/items/rogue_armor_bandit.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.roman_legion_bronze"}),
    _item("rogue", "armor", "rare", "Rogue Steel Cuirass",
          "Steel cuirass that hides well in shadow.",
          hp_bonus=26, passive_type="lifesteal_percent", passive_value=0.05,
          image_path="/items/rogue_armor_shadow.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.roman_legion_steel"}),
    _item("rogue", "armor", "epic", "Rogue Gold Lorica",
          ...
          image_path="/items/rogue_armor_shadow.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.roman_legion_gold"}),
    # --- Roman Galea Helmets (shared, 'any' class) ---
    _item("any", "helmet", "uncommon", "Roman Galea Bronze",
          "A classic bronze galea of the legions.",
          hp_bonus=10, passive_type="damage_reduction_percent", passive_value=0.02,
          image_path="/items/helmet_spangenhelm_steel.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "helmet", "asset": "helmet.roman_galea1_bronze"}),
    _item("any", "helmet", "rare", "Roman Galea Steel",
          "A reinforced steel galea worn by battle-hardened centurions.",
          hp_bonus=18, passive_type="damage_reduction_percent", passive_value=0.04,
          image_path="/items/helmet_barbuta_silver.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "helmet", "asset": "helmet.roman_galea2_steel"}),
