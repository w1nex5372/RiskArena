...
FULL_ITEM_CATALOG: List[Dict] = [
    ...
    _item("warrior", "ability", "common",   "Bash Sigil",
          "Unlocks a close-range bash that damages and stuns.",
          ability_bonus=4, ability_key="warrior_bash", ability_cooldown_ms=8000,
    ...
    _item("warrior", "ability", "rare",     "Titan Bash Sigil",
          "Unlocks a heavier bash with stronger damage and a longer stun.",
          ability_bonus=14, ability_key="warrior_titan_bash", ability_cooldown_ms=9000,
          image_path="/items/skills/warrior_titan_bash.png"),
    _item("mage",    "ability", "common",   "Fireball Rune",
          "Unlocks a ranged fireball that knocks enemies back.",
          ability_bonus=5, ability_key="mage_fireball", ability_cooldown_ms=6000,
    ...
    _item("rogue",   "ability", "common",   "Blink Charm",
          "Unlocks a blink that slips past the opponent.",
          ability_bonus=3, ability_key="rogue_blink", ability_cooldown_ms=5000,
    ...
    _item("rogue",   "ability", "rare",     "Nightfall Charm",
          "Unlocks an elite nightfall blink with the longest ambush reach.",
          ability_bonus=10, ability_key="rogue_nightfall", ability_cooldown_ms=6000,
    ...
    _item("warrior", "armor", "legendary", "Imperial Aegis",
          ...
          image_path="/items/warrior_armor_chainmail.png",
          lpc_visual={"schemaVersion": "item_lpc_visual.v1", "slot": "torso", "asset": "torso.armour.plate"}),
    _item("warrior", "ability", "epic", "Colossus Bash Sigil",
          "An empowered titan bash that crushes guards.",
          ability_bonus=20, passive_type="bonus_attack_percent", passive_value=0.08,
          ability_key="warrior_titan_bash", ability_cooldown_ms=9000,
          image_path="/items/skills/warrior_titan_bash.png"),
    _item("warrior", "ability", "legendary", "Titanfall Sigil",
          "The ultimate bash — the ground itself recoils.",
    ...
    _item("rogue", "ability", "epic", "Eclipse Charm",
          "A nightfall blink that strikes from total darkness.",
          ability_bonus=14, passive_type="risk_success_bonus", passive_value=0.08,
          ability_key="rogue_nightfall", ability_cooldown_ms=6000,
          image_path="/items/skills/rogue_nightfall.png"),
